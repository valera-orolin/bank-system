    ...
    <div class="container mx-auto px-4">
        <div class="bg-white shadow-md rounded my-6">
            ...
            <div class="px-12 pb-10">
                <div class="text-center text-5xl mb-8 font-bold">Cities</div>

                <!-- Create form -->
                <form action="/controller/cities/store.php" method="post" class="mb-4">
                    <div class="space-y-2">
                            ...
                            @foreach ($cities as $city)
                                <tr class="border-b hover:bg-orange-100">
                                    ...
                                    <td class="text-red-500 p-3 px-5">
                                        <form id="delete-form-{{ $city['id'] }}" action="/controller/cities/destroy.php" method="post" onsubmit="return confirm('Are you sure you want to delete this record?');">
                                ...
                                <tr class="border-b hidden bg-blue-100">
                                    <form id="edit-form-{{ $city['id'] }}" action="/controller/cities/update.php" method="post">
                                        <td class="p-3 px-5">
                                            <input type="hidden" name="id" value="{{ $city['id'] }}" class="border-none focus:outline-none focus:ring-0">
                                        </td>

                                        <td class="p-3 px-5"><input value="{{ $city['name'] }}" type="text" name="name" placeholder="Name" required maxlength="45" class="bg-blue-100 border-none focus:outline-none focus:ring-0"></td>
