...
if ($min_amount <= 0) {
    echo "<script>alert('Failed to update a deposit type. Minimal amount must be a positive number.'); window.location.href='/controller/deposit_types/index.php';</script>";
    die();
}
